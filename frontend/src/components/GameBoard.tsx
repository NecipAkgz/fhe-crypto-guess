...
const FHEEducationModal = dynamic(() => import('./tutorial/FHEEducationModal').then(mod => mod.FHEEducationModal), { ssr: false });
const EnvironmentSetupModal = dynamic(() => import('./tutorial/EnvironmentSetupModal').then(mod => mod.EnvironmentSetupModal), { ssr: false });
const SmartContractModal = dynamic(() => import('./tutorial/SmartContractModal').then(mod => mod.SmartContractModal), { ssr: false });
const FrontendIntegrationModal = dynamic(() => import('./tutorial/FrontendIntegrationModal').then(mod => mod.FrontendIntegrationModal), { ssr: false });
const DeploymentTestingModal = dynamic(() => import('./tutorial/DeploymentTestingModal').then(mod => mod.DeploymentTestingModal), { ssr: false });
const GlossaryModal = dynamic(() => import('./tutorial/GlossaryModal').then(mod => mod.GlossaryModal), { ssr: false });
const TutorialWizardModal = dynamic(() => import('./tutorial/TutorialWizardModal').then(mod => mod.TutorialWizardModal), { ssr: false });
const FHEPlaygroundModal = dynamic(() => import('./tutorial/FHEPlaygroundModal').then(mod => mod.FHEPlaygroundModal), { ssr: false });
const SecurityModal = dynamic(() => import('./tutorial/SecurityModal').then(mod => mod.SecurityModal), { ssr: false });
const GasAnalyzerModal = dynamic(() => import('./tutorial/GasAnalyzerModal').then(mod => mod.GasAnalyzerModal), { ssr: false });
const UseCaseGalleryModal = dynamic(() => import('./tutorial/UseCaseGalleryModal').then(mod => mod.UseCaseGalleryModal), { ssr: false });
